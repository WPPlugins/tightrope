...
<?php
  ...
  function widget($args, $instance) {
   ...
   if($company != 'not used'){
    ...
    <input type="text" name="Company" placeholder="Company Name*" maxlength="64" id="signup_Company_'.$number.'" class="field" data-status="required"/>
    <span id="company" class="error-msg"></span>
      </div>';
    }
    else if( $company == 'optional' ) {
      echo '<div class="company-wrap">
    <input type="text" name="Company" placeholder="Company Name" maxlength="64" id="signup_Company_'.$number.'" class="field" data-status="optional"/>
    <span id="company" class="error-msg"></span>
      </div>';
    }
   }
   ...
   if($location == 'required'){
    if ($location_type == 'dropdown'){
     ...
     ?>
      ...
      <select name='City' id='signup_City_<?php echo $number; ?>' class='field field_location' data-status='required'/>
      ...
      echo '<div class="location-wrap">
        <input type="text" name="City" id="signup_City_'.$number.'" class="field field_location" placeholder ="location*" data-status="required"/>
        <span id="location class="error-msg"></span>
        </div>';
    }
   }
